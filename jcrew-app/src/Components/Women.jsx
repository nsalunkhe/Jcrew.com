...
export default function Women() {
    ...
    return (
      <div>
        <Box height="150px" width="500px" textAlign="center" margin="auto" backgroundColor="rgb(10, 104, 181)" marginTop="20px" color="white" paddingTop="35px" boxShadow= "rgb(38, 57, 77) 0px 20px 30px -10px">
